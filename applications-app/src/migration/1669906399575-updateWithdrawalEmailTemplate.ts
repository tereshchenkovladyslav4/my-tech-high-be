...
export class updateWithdrawalEmailTemplate1669906399575 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE email_templates ADD priority INT DEFAULT 0`,
        );
        await queryRunner.query(
            `UPDATE email_category SET category_name="Withdrawal" WHERE category_name="Withdraw"`,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `UPDATE email_category SET category_name="Withdraw" WHERE category_name="Withdrawal"`,
        );
        await queryRunner.query(
            `ALTER TABLE email_templates DROP COLUMN priority`,
        );
    }
