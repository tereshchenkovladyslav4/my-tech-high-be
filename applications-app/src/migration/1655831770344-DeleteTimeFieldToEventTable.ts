...
export class DeleteTimeFieldToEventTable1655831770344
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`created_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`updated_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event_type\` DROP COLUMN \`created_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event_type\` DROP COLUMN \`updated_date\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`start_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` ADD \`start_date\` datetime NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`end_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` ADD \`end_date\` datetime NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` ADD \`end_date\` varchar(255) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`start_date\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` ADD \`start_date\` varchar(255) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event_type\` DROP COLUMN \`updated_at\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event_type\` DROP COLUMN \`created_at\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`updated_at\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` DROP COLUMN \`created_at\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`mth_event\` ADD \`time\` varchar(255) NULL`,
    );
  }
}
