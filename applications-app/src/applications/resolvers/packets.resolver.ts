...
export class PacketsResolver {
  ...
  @Mutation((returns) => EnrollmentPacket, { name: 'saveEnrollmentPacketContact' } )
  //@UseGuards(new AuthGuard())
  async saveEnrollmentContact(
    //@Context('user') user: User,
    @Args('enrollmentPacketContactInput') enrollmentPacketContactInput: EnrollmentPacketContactInput,
  ...
  @Mutation((returns) => EnrollmentPacket, { name: 'saveEnrollmentPacketPersonal' } )
  @UseGuards(new AuthGuard())
  async saveEnrollmentPersonal(
    @Context('user') user: User,
    @Args('enrollmentPacketPersonalInput') enrollmentPacketPersonalInput: EnrollmentPacketPersonalInput,
  ): Promise<EnrollmentPacket> {
    return await this.enrollmentsService.savePersoanl(enrollmentPacketPersonalInput);
  }

  @Mutation((returns) => EnrollmentPacket, { name: 'saveEnrollmentPacketEducation' } )
  @UseGuards(new AuthGuard())
  async saveEnrollmentEducation(
    @Context('user') user: User,
    @Args('enrollmentPacketEducationInput') enrollmentPacketEducationInput: EnrollmentPacketEducationInput,
  ): Promise<EnrollmentPacket> {
    return await this.enrollmentsService.saveEducation(enrollmentPacketEducationInput);
  }

  @Mutation((returns) => EnrollmentPacket, { name: 'saveEnrollmentPacketDocument' } )
  @UseGuards(new AuthGuard())
  async saveEnrollmentDocument(
    @Context('user') user: User,
    @Args('enrollmentPacketDocumentInput') enrollmentPacketDocumentInput: EnrollmentPacketDocumentInput
  ): 
  ...
  @Mutation((returns) => EnrollmentPacket, { name: 'saveEnrollmentPacketSubmission' } )
  @UseGuards(new AuthGuard())
  async saveEnrollmentSubmission(
    @Context('user') user: User,
    @Args('enrollmentPacketDocumentInput') enrollmentPacketSubmissionInput: EnrollmentPacketSubmissionInput
  ): 
  Promise<EnrollmentPacket|any> {
