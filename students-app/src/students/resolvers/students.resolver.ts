import { Args, ID, Query, Resolver, ResolveReference, Int, ResolveField, Parent as TypeParent, Mutation } from '@nestjs/graphql';
...
export class StudentsResolver {
  ...
  public async getPerson(@TypeParent() student: Student): Promise<Person|any> {
  ...
  @ResolveField((of) => StudentCurrentStatus, { name: 'current_school_year_status' })
  ...
  @ResolveField((of) => [StudentStatusHistory], { name: 'status_history', nullable: true })
