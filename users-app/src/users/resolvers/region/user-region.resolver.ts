...
export class UserRegionResolver {
    ...
    async createUserRegion(@Args('createUserRegionInput') createUserRegionInput: CreateUserRegionInput): Promise<UserRegion[]> {
    ...
    async updateUserRegion(@Args('updateUserRegionInput') updateUserRegionInput: UpdateUserRegionInput): Promise<UserRegion[]> {
