...
export class UserAccessResolver {
    ...
    @UseGuards(new AuthGuard())
    async createUserAccess(@Args('createUserAccessInput') createUserAccessInput: CreateUserAccessInput): Promise<UserAccess[]> {
    ...
    @UseGuards(new AuthGuard())
    async updateUserAccess(@Args('updateUserAccessInput') updateUserAccessInput: UpdateUserAccessInput): Promise<UserAccess[]> {
