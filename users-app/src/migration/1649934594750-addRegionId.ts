...
export class addRegionId1649934594750 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`mth_schoolyear\` ADD CONSTRAINT \`FK_afe4425166727024c39b94913a5\` FOREIGN KEY (\`RegionId\`) REFERENCES \`region\`(\`id\`) ON DELETE SET NULL ON UPDATE CASCADE`);
