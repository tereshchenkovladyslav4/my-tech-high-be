...
export class removeRegionId1650120274539 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`region\` ADD CONSTRAINT \`FK_54bf2818af7cc627f2f81f091a6\` FOREIGN KEY (\`region_id\`) REFERENCES \`user_region\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
